...
1. In your terminal, while inside of your Vite+React project, run the following command to install TailwindCSS:

   ```bash
   npm install tailwindcss @tailwindcss/vite
   ```

2. Inside of your `vite.config.js` file, import Tailwind plugin at the top:
   ```javascript
...
6. Delete the auto-generated contents of the `index.css` file, which was created by Vite when building the project. Then, add the following line to the top the file:
