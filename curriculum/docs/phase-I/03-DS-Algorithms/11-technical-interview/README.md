...
- Resume screen (i.e. submitting the job application and getting past HR)
- Coding Challenge on leetcode or something similar
- Technical Interview One. It could be ...
    - A technical conversation (talk about a project you've done, a technology you like, etc)
    - A whiteboarding problem

- Technical interview Two. It could be ...
    - A technical conversation (talk about a project you've done, a technology you like, etc)
    - A whiteboarding problem
    - A take-home coding assignment (a weekend project)
...
- Final, final interview (if you're here you're in the running). Sometimes just a nontechnical conversation
