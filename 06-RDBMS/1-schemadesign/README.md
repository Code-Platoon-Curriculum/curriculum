...
- [Lesson - SQL Schema Design](./1-sql-schema-design.md)
  - [Assignment - Game Store I](https://github.com/Code-Platoon-Assignments/SQL-Game-Store-I) Using what we've covered about creating schema designs use drawSQL to create a table for Employees, Posters, and Action Figures from the provided csv data.
