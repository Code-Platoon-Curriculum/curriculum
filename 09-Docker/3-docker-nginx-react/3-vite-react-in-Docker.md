...
Before we do anything, we have to install Vite + React.js. To do this we will utilize the npm scripts to easily get the Vite + React.js template created for us.

#### Install Vite + React.js 

To install Vite + React.js, navigate to the directory you will use then do the following commands in series, after being prompted following the first command.
